...
ArgumentParser::ArgumentParser() {
    specs_ = {
        {"--enable", FlagSpec::ArgKind::CSV},
        {"--disable", FlagSpec::ArgKind::CSV},
        {"--output", FlagSpec::ArgKind::String},
        {"--min-severity", FlagSpec::ArgKind::String},
        {"--fail-on", FlagSpec::ArgKind::String},
        {"--pretty", FlagSpec::ArgKind::None},
        {"--compact", FlagSpec::ArgKind::None},
        {"--canonical", FlagSpec::ArgKind::None},
        {"--ndjson", FlagSpec::ArgKind::None},
        {"--sarif", FlagSpec::ArgKind::None},
        {"--all-processes", FlagSpec::ArgKind::None},
        {"--modules-summary", FlagSpec::ArgKind::None},
        {"--modules-anomalies-only", FlagSpec::ArgKind::None},
        {"--modules-hash", FlagSpec::ArgKind::None},
        {"--integrity", FlagSpec::ArgKind::None},
        {"--integrity-ima", FlagSpec::ArgKind::None},
        {"--integrity-pkg-verify", FlagSpec::ArgKind::None},
        ...
        {"--world-writable-exclude", FlagSpec::ArgKind::CSV},
        {"--process-hash", FlagSpec::ArgKind::None},
        {"--process-inventory", FlagSpec::ArgKind::None},
        {"--max-processes", FlagSpec::ArgKind::Int},
        {"--max-sockets", FlagSpec::ArgKind::Int},
        {"--network-debug", FlagSpec::ArgKind::None},
        {"--network-listen-only", FlagSpec::ArgKind::None},
        {"--network-proto", FlagSpec::ArgKind::String},
        {"--network-states", FlagSpec::ArgKind::CSV},
        {"--network-advanced", FlagSpec::ArgKind::None},
        {"--network-fanout", FlagSpec::ArgKind::Int},
        {"--network-fanout-unique", FlagSpec::ArgKind::Int},
        {"--ioc-allow", FlagSpec::ArgKind::CSV},
        {"--ioc-allow-file", FlagSpec::ArgKind::String},
        {"--ioc-env-trust", FlagSpec::ArgKind::None},
        {"--ioc-exec-trace", FlagSpec::ArgKind::OptionalInt},
        {"--suid-expected", FlagSpec::ArgKind::CSV},
        {"--suid-expected-file", FlagSpec::ArgKind::String},
        {"--parallel", FlagSpec::ArgKind::None},
        {"--parallel-threads", FlagSpec::ArgKind::Int},
        {"--hardening", FlagSpec::ArgKind::None},
        {"--containers", FlagSpec::ArgKind::None},
        {"--container-id", FlagSpec::ArgKind::String},
        {"--rules-enable", FlagSpec::ArgKind::None},
        {"--rules-dir", FlagSpec::ArgKind::String},
        {"--rules-allow-legacy", FlagSpec::ArgKind::None},
        {"--sign-gpg", FlagSpec::ArgKind::String},
        {"--slsa-level", FlagSpec::ArgKind::String},
        {"--compliance", FlagSpec::ArgKind::None},
        {"--compliance-standards", FlagSpec::ArgKind::CSV},
        {"--drop-priv", FlagSpec::ArgKind::None},
        {"--keep-cap-dac", FlagSpec::ArgKind::None},
        {"--seccomp", FlagSpec::ArgKind::None},
        {"--seccomp-strict", FlagSpec::ArgKind::None},
        {"--no-user-meta", FlagSpec::ArgKind::None},
        {"--no-cmdline-meta", FlagSpec::ArgKind::None},
        {"--no-hostname-meta", FlagSpec::ArgKind::None},
        {"--write-env", FlagSpec::ArgKind::String},
        {"--fast-scan", FlagSpec::ArgKind::None},
        {"--timings", FlagSpec::ArgKind::None},
        {"--fail-on-count", FlagSpec::ArgKind::Int}
    };
}
